...
esp_lcd_touch_handle_t touch_init(uint16_t width, uint16_t height)
{
    ...
    const i2c_master_bus_config_t touch_i2c_bus_config = {
        ...
        .i2c_port = -1,
        .scl_io_num = CONFIG_TOUCH_PIN_I2C_SCL,
        .sda_io_num = CONFIG_TOUCH_PIN_I2C_SDA,
        .glitch_ignore_cnt = 7,
#if CONFIG_TOUCH_I2C_PULLUP
...
#if CONFIG_ESP_LCD_TOUCH_IO_I2C_GT911_ADDRESS_BACKUP
        .dev_addr = ESP_LCD_TOUCH_IO_I2C_GT911_ADDRESS_BACKUP,
#elif CONFIG_ESP_LCD_TOUCH_IO_I2C_GT911_ADDRESS
    ...
    const esp_lcd_touch_config_t gt911_touch_cfg = {
        .x_max = lcd_width,
        .y_max = lcd_height,
        .rst_gpio_num = CONFIG_TOUCH_PIN_RST,
        .int_gpio_num = CONFIG_TOUCH_PIN_INT,
        .levels = {
            .reset = 0,
            .interrupt = 0,
        },
